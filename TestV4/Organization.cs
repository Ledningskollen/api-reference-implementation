...
namespace TestV4 {
    ...
    public class Organization {
        ...
        private async Task<CableOwnerCase> CableOwnerCaseByNumber_JSON(string caseNumber = null) {
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP GET
                var response = await client.GetAsync(string.Format("organization/{0}/cableownercase/{1}",
                    _context.OrganizationId, caseNumber));
        ...
        private static async Task<List<CableOwnerCase>> GetCableOwnerCases_JSON(string status, int limit = 100,
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP GET
                var response = await client.GetAsync(string.Format("organization/{0}/cableownercases/{1}/{2}",
                    context.OrganizationId, status, limit));
        ...
        private static async Task<List<CableOwnerCase>>
            GetCableOwnerCases_Before_JSON(string status, string caseNumber, int limit = 100) {
            List<CableOwnerCase> result;
            ...
            using (var client = new HttpClient()) {
                ...
                var response = await client
                    .GetAsync(
                        string.Format("organization/{0}/cableownercases/{1}/before/{2}/{3}", _context.OrganizationId,
                            status, caseNumber, limit));
                result = response.IsSuccessStatusCode
        ...
        private static async Task<List<CableOwnerCase>> GetCableOwnerCases_After_JSON(string status, string caseNumber,
            int limit = 100) {
            List<CableOwnerCase> result;
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP GET
                var response = await client.GetAsync(string.Format("organization/{0}/cableownercases/{1}/after/{2}/{3}",
                    _context.OrganizationId, status, caseNumber, limit));
                result = response.IsSuccessStatusCode
                    ? JsonUtils<List<CableOwnerCase>>.Deserialize(
                        response.Content.ReadAsStringAsync().Result)
                    : null;
        ...
        private async Task<List<CableOwnerCase>> PostCableOwnerCases_Filter(CaseFilters filters) {
            ...
            using (var client = new HttpClient()) {
                ...
                var response = await client.PostAsync(
                    string.Format("organization/{0}/cableownercasefilter", _context.OrganizationId), stringContent);

                result = JsonUtils<List<CableOwnerCase>>.Deserialize(response.Content.ReadAsStringAsync().Result,
                    response.IsSuccessStatusCode);
            }
            return result;
        }

        public static async Task<List<CableOwnerCase>> GetCableOwnerCases_Filter(string caseNumber = null,
            int? limit = null, DateTime? fromDate = null, DateTime? toDate = null, string[] types = null,
            string status = null, Guid[] recipientList = null, Context context = null) {
            if (context == null) {
                context = _context;
            }
            ...
            using (var client = new HttpClient()) {
                ...
                var response =
                    await client.GetAsync(
                        string.Format("organization/{0}/cableownercasefilter", context.OrganizationId) + queryString);
        ...
        private static async Task<KeyValuePair<string, byte[]>> GetCableOwnerCasePdf(string organizationId,
            string caseId) {
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP GET
                var response = await client.GetAsync(string.Format("organization/{0}/cableownercase/{1}/pdf",
        ...
        public static string GetFileNameFromContentDisposition(HttpResponseMessage response) {
            var fileName = string.Empty;
            try {
                var contentDisposition = response.Content.Headers.First(h =>
                    h.Key.Equals("Content-Disposition", StringComparison.OrdinalIgnoreCase));
                var fileNameObj = contentDisposition.Value.First(v => v.Contains("filename"));
        ...
        private static async Task<KeyValuePair<string, byte[]>> GetCableOwnerCaseGeometries(string organizationId,
            string caseNumber, int coordinateSystem, string dataFormat) {
            byte[] bytes;
            var fileName = string.Empty;
            using (var client = new HttpClient()) {
                //Set timeout to 20 seconds
                ...
                client.DefaultRequestHeaders.Add("X-Auth-Token", _context.Token);
                // HTTP GET
                var url = string.Format("organization/{0}/cableownercase/{1}/geometries/{2}/{3}", organizationId,
                    caseNumber, coordinateSystem, dataFormat);
        ...
        private static async Task<KeyValuePair<string, byte[]>> GetAreaGeometries(string organizationId, string areaId,
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP GET
                var response = await client.GetAsync(string.Format("organization/{0}/area/{1}/geometries/{2}/{3}",
                    organizationId, areaId, coordinateSystem, dataFormat));
                bytes = response.IsSuccessStatusCode ? await response.Content.ReadAsByteArrayAsync() : null;
        ...
        private static async Task<Recipient> OrganizationRecipient_JSON(string organizationId, string recipientId) {
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP GET
                var response =
                    await client.GetAsync(string.Format("organization/{0}/recipient/{1}", organizationId, recipientId));
        ...
        private static async Task<XmlDocument> OrganizationRecipients_XML() {
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP GET
                var response =
                    await client.GetAsync(string.Format("organization/{0}/recipient", _context.OrganizationId));
                if (!response.IsSuccessStatusCode) {
                    return result;
                }
                var xml = response.Content.ReadAsStringAsync().Result;
        ...
        private static async Task<List<Area>> GetArea_JSON(string areaId = null) {
            ...
            using (var client = new HttpClient()) {
                ...
                var url = string.Format(
                    "organization/{0}/area" + (!string.IsNullOrEmpty(areaId) ? "/" + areaId : string.Empty),
                    _context.OrganizationId);
                // HTTP GET
                var response = await client.GetAsync(url);
                result = response.IsSuccessStatusCode
        ...
        private async Task<Event> PostReply(string caseNumber, string areaType, string recipientId, Reply reply) {
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP POST
                var response = await client.PostAsync(
                    string.Format("organization/{0}/cableownercase/{1}/{2}/caserecipient/{3}/reply",
                        _context.OrganizationId, caseNumber, areaType, recipientId), stringContent);

                result = JsonUtils<Event>.Deserialize(response.Content.ReadAsStringAsync().Result,
                    response.IsSuccessStatusCode);
            }
            return result;
        }
        ...
        private async Task<bool> TakeCase(string caseNumber, string areaType, string recipientId) {
            ...
            using (var client = new HttpClient()) {
                ...
                //HTTP POST 
                var response = await client.PostAsync(
                    string.Format("organization/{0}/cableownercase/{1}/{2}/caserecipient/{3}/take",
                        _context.OrganizationId, caseNumber, areaType, recipientId), new StringContent(""));
                result = response.IsSuccessStatusCode;
            }
            return result;
        }
        ...
        private async Task<KeyValuePair<string, byte[]>> GetAttachment(string caseNumber,
            ...
            using (var client = new HttpClient()) {
                ...
                var response =
                    await client.GetAsync(
                        string.Format("inquiry/{0}/attachment/{1}?zip={2}", caseNumber, fileName, zip));
        ...
        private static async Task<List<Measures>> GetMeasures(string areaType, string caseType) {
            ...
            using (var client = new HttpClient()) {
                ...
                // HTTP GET
                var response = await client.GetAsync(string.Format("organization/{0}/measures/{1}/{2}",
                    _context.OrganizationId, areaType, caseType));
        ...
        private async Task ReassignRecipient(string caseNumber, string areaType, ReassignRecipient reassignRecipient) {
            ...
            using (var client = new HttpClient()) {
                ...
                var jsonString = JsonUtils<ReassignRecipient>.Serialize(reassignRecipient);
                var stringContent = new StringContent(jsonString);
                stringContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = await client.PostAsync(
                    string.Format("organization/{0}/cableownercase/{1}/{2}/reassign", _context.OrganizationId,
                        caseNumber, areaType), stringContent);
        ...
        private Reply CreateReplyObject(CableOwnerCase coCase, CableOwnerCaseRecipient caseRecipient) {
            ...
            Assert.IsTrue(Constants.MeasuresPerCaseType.ContainsKey(coCase.Type), "Case type is not valid.");
        ...
        /// </summary>
        private void ChecksForCableOwnerCase(IEnumerable<CableOwnerCase> leftList,
            IEnumerable<CableOwnerCase> rightList, bool skipFirst = false) {
            if (skipFirst) leftList = leftList.Skip(1).ToList();

            foreach (var c in leftList)
                Assert.That(rightList.Count(x => x.Id.Equals(c.Id)), Is.EqualTo(1),
                    string.Format("The second list does not contain the case {0}", c.Id));
        }

        /// <summary>
        ///     Loops through a list of cases and performs basic checking
        /// </summary>
        private void ChecksForCableOwnerCase(IEnumerable<CableOwnerCase> caseList) {
            foreach (var c in caseList) ChecksForCableOwnerCase(c);
        }
        ...
        private void ChecksForCableOwnerCase(CableOwnerCase coCase) {
            ...
            Assert.GreaterOrEqual(coCase.Recipients.Count, 1, "No recipients for this case. " + coCase.Id);
        }
        ...
        private void ChecksForRecipient(List<Recipient> recipientList) {
            ...
            foreach (var r in recipientList) ChecksForRecipient(r);
        }
        ...
        private void ChecksForRecipient(Recipient recipient) {
            ...
            Assert.IsTrue(recipient.Id != default(Guid).ToString(), "The recipient id has default value.");
            Assert.IsNotNullOrEmpty(recipient.Name, "The recipient does not have name.");
            Assert.IsNotNull(recipient.ContactInfo, "The recipient does not have contact information.");
        }
        ...
        private void ChecksForEvent(Event eventModel, Reply reply) {
            Assert.IsNotNullOrEmpty(eventModel.Comment, "The event comment can not be empty.");
            Assert.IsNotNull(eventModel.Time, "The event does not have time of creation.");
            Assert.GreaterOrEqual(eventModel.Measure.Count, 1, "The event does not have measures.");
            Assert.AreEqual(reply.Action, eventModel.Measure, "The event action is not valid.");
        }
        ...
        public void GetAllAttachments() {
            ...
            var caseWithAttachment = caseList.FirstOrDefault(c => c.PlanningInquiry.Attachments.Any());
            if (caseWithAttachment != null) {
                var taskZip = GetAttachment(caseWithAttachment.Id, HttpUtility.UrlPathEncode("all"), false);

                Assert.IsNotNull(taskZip, "The task was null");
                Assert.IsNotNull(taskZip.Result, "There result is empty");

                Assert.That(taskZip.Result.Value.Length, Is.GreaterThan(1), "The result is not an attachment.");
                //Save file as requested in ticket comment

                using (var sourceStream = new FileStream(taskZip.Result.Key, FileMode.Append, FileAccess.Write)) {
                    sourceStream.Write(taskZip.Result.Value, 0, taskZip.Result.Value.Length);
                }
            } else {
                Assert.Fail("I can't do a test without knowing which case has an attachment.");
        ...
        public void GetAttachments() {
            ...
            var caseWithAttachment = caseList.FirstOrDefault(c => c.PlanningInquiry.Attachments.Any());
            if (caseWithAttachment != null) {
                var attachmentName = caseWithAttachment.PlanningInquiry.Attachments.First();

                var taskFile = GetAttachment(caseWithAttachment.Id, HttpUtility.UrlPathEncode(attachmentName), false);
                var taskZip = GetAttachment(caseWithAttachment.Id, HttpUtility.UrlPathEncode(attachmentName), true);
                ...
                Assert.That(taskFile.Result.Value.Length, Is.GreaterThan(1), "The result is not an attachment.");
                Assert.That(taskZip.Result.Value.Length, Is.GreaterThan(1), "The result is not an attachment.");
                //Save file as requested in ticket comment
                using (var sourceStream = new FileStream(taskFile.Result.Key, FileMode.Append, FileAccess.Write)) {
        ...
        public void GetCableOwnerCasesAsJson() {
            ...
            var statuses = new[] {"toconfirm", "confirmed", "canceled", "historical"};
            foreach (var s in statuses) {
                ...
                ChecksForCableOwnerCase(cases.Result.Where(x => x.Recipients.Any()));

                // Get the nine cases before the last case
                var casesBefore = GetCableOwnerCases_Before_JSON(s, cases.Result.First().Id, 9);
                Assert.IsNotNull(casesBefore);
                Assert.IsNotNull(casesBefore.Result);

                // Get the nine cases after the first case
                var casesAfter = GetCableOwnerCases_After_JSON(s, cases.Result.Last().Id, 9);
                ...
                ChecksForCableOwnerCase(casesBefore.Result.Take(casesBefore.Result.Count - 1).ToList(),
        ...
        public void GetCaseByFilterExtended() {
            ...
            var caseList = GetCableOwnerCases_Filter(limit: 10,
                    caseNumber: CaseNumber,
        ...
        public void GetCaseGeometries() {
            var coordinateSystem = Constants.LkSupportedCoordinateSystems().Values.OrderBy(x => Guid.NewGuid()).First();
            const string dataFormat = "WKT";

            var task = GetCableOwnerCaseGeometries(_context.OrganizationId, CaseNumber, coordinateSystem, dataFormat);
        ...
        public void GetCasePdf() {
            var task = GetCableOwnerCasePdf(_context.OrganizationId, CaseNumber);
            Assert.IsNotNull(task, "The task was null");
            ...
            var result = Encoding.UTF8.GetString(fileBytes.Take(7).ToArray());
            Assert.IsTrue(result == "%PDF-1.");

            //Save file as requested in ticket comment
            var fileName = string.IsNullOrWhiteSpace(task.Result.Key) ? CaseNumber + ".pdf" : task.Result.Key;
            using (var sourceStream = new FileStream(fileName, FileMode.Append, FileAccess.Write)) {
        ...
        public void GetCasePdfUsingWebRequest() {
            ...
            try {
                using (var client = new WebClient()) {
                    ...
                    var stream = client.OpenRead(string.Format("organization/{0}/cableownercase/{1}/pdf",
                        _context.OrganizationId, CaseNumber));
                    ...
                    using (var ms = new MemoryStream()) {
                        ...
                        using (var sourceStream =
                            new FileStream(CaseNumber + ".pdf", FileMode.Append, FileAccess.Write)) {
                            ms.Position = 0;
        ...
        public void GetOrganizationRecipientAsJson() {
            //Get all recipients
            var taskGetAllRecipients = OrganizationRecipients_JSON();
            ...
            var taskGetRecipient = OrganizationRecipient_JSON(_context.OrganizationId, firstRecipient.Id);
            ...
            Assert.That(firstRecipient.Name, Is.EqualTo(secondCallRecipient.Name));
            Assert.That(firstRecipient.ContactInfo.Address, Is.EqualTo(secondCallRecipient.ContactInfo.Address));
            Assert.That(firstRecipient.ContactInfo.PhoneNumber,
                Is.EqualTo(secondCallRecipient.ContactInfo.PhoneNumber));
            Assert.That(firstRecipient.ContactInfo.Email, Is.EqualTo(secondCallRecipient.ContactInfo.Email));
            Assert.That(firstRecipient.ContactInfo.FaxNumber, Is.EqualTo(secondCallRecipient.ContactInfo.FaxNumber));
        ...
        public void PostReplyToAllCaseTypes_Test() {
            ...
            foreach (var caseType in caseTypes) {
                var caseList = GetCableOwnerCases_Filter(
                    ...
                    limit: 1,
                    status: EnumUtils.ToDescription(Constants.Case_Status.TO_CONFIRM));
                var firstCase = caseList.Result.FirstOrDefault();
                Assert.That(firstCase, Is.Not.Null, "There are no applicable cases for this test");
        ...
        public void ReassignRecipient_Test() {
            ...
            var recipientsWithout = allRecipients.Where(r => r.Id != recipientFrom.Recipient.Id);
            ...
            var caseAfterSwitchRecipient = CableOwnerCaseByNumber_JSON(caze.Id).Result;
            Assert.AreEqual(caze.Id, caseAfterSwitchRecipient.Id,
                "Case id is different (" + caze.Id + ", " + caseAfterSwitchRecipient.Id + ")");
            Assert.AreEqual(caze.Type, caseAfterSwitchRecipient.Type, "The case types are not the same");
        ...
        public void ReassignRecipientForAllCaseTypes_Test() {
            ...
            foreach (var caseType in caseTypes) {
                ...
                var caseAfterSwitchRecipient = CableOwnerCaseByNumber_JSON(firstCase.Id).Result;
                Assert.AreEqual(firstCase.Id, caseAfterSwitchRecipient.Id,
                    string.Format("Case id is different ({0}), {1}", firstCase.Id, caseAfterSwitchRecipient.Id));
                Assert.AreEqual(firstCase.Type, caseAfterSwitchRecipient.Type, "The case types are not the same");
                Assert.True(caseAfterSwitchRecipient.Recipients.Any(cr => cr.Recipient.Id == recipientTo.Id),
                    "The new recipient was not assigned");
        ...
        public void TakeCase_Test() {
            ...
            var takenCaseRecipient =
                takenCase.Result.Recipients.First(r => r.Recipient.Id == firstCaseRecipient.Recipient.Id);
            ...
            var toConfirmCaseIds =
                GetCableOwnerCases_JSON(EnumUtils.ToDescription(Constants.Case_Status.TO_CONFIRM), 10).Result
                    .Select(c => c.Id).ToList();

            Assert.That(toConfirmCaseIds.Contains(firstCase.Id), Is.False,
                "The taken case should not be in the toconfirm list");
        }
        ...
        public void TakeCasePerCaseType_Test() {
            ...
            foreach (var caseType in caseTypes) {
                ...
                //Pick the first case which requires manual review
                var firstCase = caseList.Result.FirstOrDefault(c => c.Recipients.Any(r => r.Status == "requires review"));
                Assert.That(firstCase, Is.Not.Null, "There are no applicable cases for this test");
                ...
                Assert.That(toConfirmCases.Select(cc => cc.Id).Contains(firstCase.Id)
                            && toConfirmCases.Any(ci => ci.Id == firstCase.Id &&
                                                        ci.Recipients.Where(cr => cr.Status.Equals("requires review"))
                                                            .Any(cr => cr.Recipient.Id ==
                                                                       firstCaseRecipient.Recipient.Id
